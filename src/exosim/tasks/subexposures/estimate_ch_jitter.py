...
from exosim.tasks.instrument.compute_sources_pointing_offset import angle_of_view
...
class EstimateChJitter(Task):
    ...
    def execute(self):
        ...
        jitter_spa, jitter_spe, jitter_time = self.get_task_param("pointing_jitter")
        ...
        new_freq = np.ceil(jitter_freq.value / readout_freq.value) * readout_freq
