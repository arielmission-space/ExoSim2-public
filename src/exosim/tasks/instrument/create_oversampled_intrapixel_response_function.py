...
class CreateOversampledIntrapixelResponseFunction(CreateIntrapixelResponseFunction):
    def model(self, parameters):
        ...
        # TODO find a better zeroing method. It should be enough if the zeros are twice the size of the kernel.
