...
class SaturationChannel(Task):
    """
    It computes and adds the saturation time to the radiometric table using :class:`~exosim.tasks.instrument.compute_saturation.ComputeSaturation`.
    ...
    def __init__(self):
        ...
        self.add_task_param("input_file", "fraction of detector well depth to use")
    ...
    def execute(self):
        ...
        with input_file.open() as f:
            ...
            focal_plane = (
                f[ch]["focal_plane"]["data"][0, osf // 2 :: osf, osf // 2 :: osf]
                * focal_plane_units
            )
            frg_focal_plane = (
                f[ch]["frg_focal_plane"]["data"][0, osf // 2 :: osf, osf // 2 :: osf]
                * focal_plane_units
            )

            sat_, _max_sig, _min_sig = computeSaturationTime(
            ...
            saturation_time = [sat_] * len(table[table["ch_name"] == ch])
        ...
        self.set_output([saturation_time, max_signal_in_bin, min_signal_in_bin])
