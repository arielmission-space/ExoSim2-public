...
class LoadOpticalElement(Task):
    ...
    def execute(self):
        ...
        radiance, efficiency = self.model(parameters=parameters, wavelength=wl, time=tt)
    ...
    def model(self, parameters, wavelength, time):
        ...
        if "efficiency_key" in parameters:
        ...
        # else we estimate it
            ...
            if "emissivity_key" in parameters:
        ...
        self.debug(f"radiance: {radiance.data}")
    ...
    def _get_data(self, parameters, wl, tt, read_key, signal_type):
        ...
        self.debug(f"emissivity: {extracted_data.data}")
