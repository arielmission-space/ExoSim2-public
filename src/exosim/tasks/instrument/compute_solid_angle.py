...
# todo change name AOmega or throughput
class ComputeSolidAngle(Task):
    ...
    def execute(self):
        ...
        if other_parameters and "solid_angle" in other_parameters:
