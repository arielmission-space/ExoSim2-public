...
class CreateCustomSource(Task):
    ...
    def __init__(self):
        ...
        -----------
        parameters: dict
            dictionary containing the source parameters. This is usually parsed from :class:`~exosim.tasks.load.load_options.LoadOptions`
        """
    ...
    def model(self, parameters):
        ...
        ----------
        parameters: dict
            dictionary contained the source parameters. This is usually parsed from :class:`~exosim.tasks.load.load_options.LoadOptions`.
        ...
        return signal.Sed(spectral=wl, data=omega_star * bb_)
